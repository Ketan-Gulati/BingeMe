...
function Header() {
  ...
  return (
    <header className='w-full shadow sticky top-0 z-50'>
        <nav className='bg-[#1E1E1E] px-4 lg:px-6 py-2.5 w-full'>
            <div className="flex justify-between items-center w-full">
                ...
                <div className='flex items-center gap-7'>
                  ...
                  <Link to="/" className="flex items-center">
                    <img src='/BingeMe.png' className='mr-3 h-12' alt="Logo"></img>
                  </Link>
                </div>
                ...
                <div className='flex items-center'>
                  ...
                  <div className='rounded-r-3xl bg-[#343434] border-1 border-[#5B5B5B] px-5 py-2 cursor-pointer' onClick={(e)=>setSearchQuery(e.target.value)}>
